    ...
    <div class="czca-container">
        <section class="project-info">
            ...
            <div class="tech-features">
                <div class="feature">
                    <h3>{{ t.features.analysis.title }}</h3>
        ...
        <div class="project-links">
            <a href="https://github.com/yourusername/czca-project" target="_blank" rel="noopener noreferrer" class="view-project-btn github">
...
import { translations } from '@/translations/czca';
